...
#define kCOStickerViewControlSize 36.0


@interface COStickerView ()
    ...
    else if ([recognizer state] == UIGestureRecognizerStateChanged)
    {
        if (self.bounds.size.width < minWidth || self.bounds.size.height < minHeight)
        {
            self.bounds = CGRectMake(self.bounds.origin.x,
                                     ...
                                     minWidth+1,
                                     minHeight+1);
            resizingControl.frame =CGRectMake(self.bounds.size.width-kCOStickerViewControlSize,
                                              self.bounds.size.height-kCOStickerViewControlSize,
                                              kCOStickerViewControlSize,
                                              kCOStickerViewControlSize);
            deleteControl.frame = CGRectMake(0, 0,
                                             kCOStickerViewControlSize, kCOStickerViewControlSize);
            customControl.frame =CGRectMake(self.bounds.size.width-kCOStickerViewControlSize,
                                            0,
                                            kCOStickerViewControlSize,
                                            kCOStickerViewControlSize);
            prevPoint = [recognizer locationInView:self];
...
- (void)setupDefaultAttributes {
    borderView = [[COGripViewBorderView alloc] initWithFrame:CGRectInset(self.bounds, kSPUserResizableViewGlobalInset, kSPUserResizableViewGlobalInset)];
    ...
    deleteControl.image = [UIImage imageNamed:@"COBtn3" ];
    ...
    resizingControl = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width-kCOStickerViewControlSize,
                                                                   self.frame.size.height-kCOStickerViewControlSize,
                                                                   kCOStickerViewControlSize, kCOStickerViewControlSize)];
    resizingControl.backgroundColor = [UIColor clearColor];
    resizingControl.userInteractionEnabled = YES;
    resizingControl.image = [UIImage imageNamed:@"COBtn2" ];
    ...
    customControl = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width-kCOStickerViewControlSize,
                                                                 0,
                                                                 kCOStickerViewControlSize, kCOStickerViewControlSize)];
...
{
    switch (type) {
        case COStickerView_BUTTON_RESIZE:
            resizingControl.image = image;
            break;
        case COStickerView_BUTTON_DEL:
            deleteControl.image = image;
            break;
        case COStickerView_BUTTON_CUSTOM:
